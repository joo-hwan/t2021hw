...
public class PaymentDto {
	 ...
	 */
	@QueryProjection
	public PaymentDto(String pmtId, String mbrId, PayGroup pmtCode, PayType pmtType, String succYn, String succMsg, String aprvType, Timestamp aprvTime, Long pmtAmt) {
		this.pmtId = pmtId;
		this.mbrId = mbrId;
		this.pmtCode = pmtCode == null ? null : pmtCode.name();
		this.pmtType = pmtType == null ? null : pmtType.name();
		this.succYn = succYn;
		this.succMsg = succMsg;
		this.aprvType = aprvType;
		this.aprvTime = aprvTime;
